...
export class Recorder {
	...
	public record(): void {
		this.addListenerForRecordingEvent(
			this.execution.stdout,
			"stdout",
			"data",
			"data",
			(data) => data.toString()
	...
	private generateEvent(
		...
		(<any>event)[eventName] = this.generateEventArguments(
			argumentName,
			argument
		);
	...
	private generateEventArguments(
		argumentName: string,
		argument: any
	): IEventArguments {
