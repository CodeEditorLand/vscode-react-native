...
export function startSmokeTests(
	...
	describe("Extension smoke tests", () => {
		...
		startDebugScenariosCreationTests(
			testApplicationSetupManager.getRnProject()
		);
		startDebuggingViaDynamicConfigsTests(
			testApplicationSetupManager.getRnProject()
		);
		...
		startDirectDebugTests(
			testApplicationSetupManager.getHermesProject(),
			args
		);
		startExpoTests(
