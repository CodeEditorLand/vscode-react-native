	...
	describe("Debugging scenarios creation test", () => {
		...
		before(async () => {
			...
			SmokeTestLogger.info(
				"Debugging scenarios creation test: launch.json file is opened"
			);
		});
		...
		describe("Add Run scenarios", () => {
			it("Add Run iOS debugging scenario", async function () {
				...
				await app.workbench.quickinput.selectQuickInputElement(
					0,
					false
				);
				SmokeTestLogger.info(
					"Debugging scenarios creation test: select iOS option"
				);
				await app.workbench.quickinput.selectQuickInputElement(
					1,
					false
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: save launch.json file"
				);
				...
				let configurations =
					launchConfigurationManager.getLaunchScenarios()
						.configurations;
				assert.strictEqual(
		...
		describe("Add Debug scenarios", () => {
			...
			it("Add Debug macOS Hermes - Experimental debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: select macOS option"
				);
				await app.workbench.quickinput.selectQuickInputElement(
					2,
					false
			...
			it("Add Debug Android Hermes - Experimental debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: select Android option"
				);
				await app.workbench.quickinput.selectQuickInputElement(
					0,
					false
			...
			it("Add Debug in Exponent debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: select Exponent option"
				);
				await app.workbench.quickinput.selectQuickInputElement(
					4,
					false
		...
		describe("Add Attach scenarios", () => {
			it("Add Attach to packager debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: skip port changing"
				);
				await app.workbench.quickinput.selectQuickInputElement(0);
				SmokeTestLogger.info(
					"Debugging scenarios creation test: save launch.json file"
			...
			it("Add Attach to Hermes application - Experimental debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					`Debugging scenarios creation test: skip address changing`
				);
				await app.workbench.quickinput.selectQuickInputElement(
					0,
					false
			...
			it("Add Attach to Direct iOS - Experimental debugging scenario", async function () {
				...
				SmokeTestLogger.info(
					"Debugging scenarios creation test: select Direct iOS option"
				);
				await app.workbench.quickinput.selectQuickInputElement(
					1,
					false
				...
				assert.strictEqual(
					configurations && (configurations[0] as any).port,
					9221
				);
				assert.strictEqual(
					configurations && configurations[0].type,
