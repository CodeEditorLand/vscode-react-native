...
export class SmokeTestLogger {
	...
	public static info(...str: string[]): void {
		console.log(
			SmokeTestLogger.colorize(str.join(" "), ansiСolors.styles.blue)
		);
	}
	public static warn(...str: string[]): void {
		console.log(
			SmokeTestLogger.colorize(str.join(" "), ansiСolors.styles.yellow)
		);
	}
	public static success(...str: string[]): void {
		console.log(
			SmokeTestLogger.colorize(str.join(" "), ansiСolors.styles.green)
		);
	}
	public static projectInstallLog(...str: string[]): void {
		console.log(
			SmokeTestLogger.colorize(
				str.join(" "),
				ansiСolors.styles.cyanBright
			)
		);
	}
	public static projectPatchingLog(...str: string[]): void {
		console.log(
			SmokeTestLogger.colorize(
				str.join(" "),
				ansiСolors.styles.magentaBright
			)
		);
	}
	public static error(err: string | Error): void {
		console.error(
			SmokeTestLogger.colorize(err.toString(), ansiСolors.styles.red)
		);
	}
